...
public class BlockPrimaryBlueprintTable extends BlockContainer implements IHasModel {
    public final String name = "primary_blueprint_table";
    public BlockPrimaryBlueprintTable() {
        super(Material.ROCK);
    ...
    public TileEntity createNewTileEntity(World worldIn, int meta) {
        return new TEPrimaryBlueprintTable();
    }

    @Override
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
        if(!worldIn.isRemote){
            int id = GUIHandler.GUIPrimaryBlueprintTable;
