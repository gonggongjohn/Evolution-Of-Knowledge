...
public class ButtonSecondaryBlueprintTableCenter extends GuiButton {
    private Item content;
    private GUISecondaryBlueprintTable fatherInstance;

    public ButtonSecondaryBlueprintTableCenter(int buttonId, int x, int y, int widthIn, int heightIn, GUISecondaryBlueprintTable fatherInstance) {
