...
public class MerchantTradeData {
	 ...
	 * NPC交易列表
	 */
	public static final ArrayList<MerchantTradeData> TradeList = new ArrayList<MerchantTradeData>();
	...
	public static ArrayList<MerchantTradeData> getRandomTrades(int level) {
		...
		ArrayList<MerchantTradeData> availableTrades = new ArrayList<MerchantTradeData>();
