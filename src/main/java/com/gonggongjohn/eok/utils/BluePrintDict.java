...
public class BluePrintDict {
    public final Map<MetaItem<?>.MetaValueItem, String[]> textureMap = new HashMap<>();
    public final Map<MetaItem<?>.MetaValueItem, Integer> maxPageSize = new HashMap<>();
    ...
    {
        for (String s : textureLocation) {
            ResourceLocation location = new ResourceLocation(EOK.MODID + ":" + "textures/gui/container/blueprint/" + blueprint.unlocalizedName + "/" + s);
