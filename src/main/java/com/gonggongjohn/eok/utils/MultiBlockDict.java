...
public class MultiBlockDict {
    public final HashMap<String, ArrayList<ComponentRelation>> structureDictLinear = new HashMap<>();
    public final HashMap<String, ArrayList<ComponentRelation>> structureDict2D = new HashMap<>();
    public final HashMap<String, ArrayList<ComponentRelation>> structureDict3D = new HashMap<>();
    /**
     * Block's Unlocalized Name -> Structure Name
     */
    public final HashMap<String, String> structureNameDict = new HashMap<>();
    /**
     * Structure Name -> Dimension Number
     */
    public final HashMap<String, Integer> structureDimensionDict = new HashMap<>();
    /**
     * Structure Name -> Replacement Block Instance
     */
    public final HashMap<String, Block> structureReplaceDict = new HashMap<>();
    private final Block stoneTable = BlockHandler.blockStoneTable;
    ...
    private ArrayList<ComponentRelation> createStructure(ComponentRelation... relations) {
        ArrayList<ComponentRelation> list = new ArrayList<>(Arrays.asList(relations));
        return list;
    }
