...
public class PacketInspirations implements IMessage {
    ...
    public static class Handler implements IMessageHandler<PacketInspirations, IMessage> {

        @Override
        public IMessage onMessage(PacketInspirations message, MessageContext ctx) {
