...
public class AnotherEventHandler {
    ...
    public void onPlayerClone(PlayerEvent.Clone event){
        ...
        if(event.getOriginal().hasCapability(capabilityInspirations, null) && event.getEntityPlayer().hasCapability(capabilityInspirations, null)){
            NBTBase nbt = storageInspiration.writeNBT(capabilityInspirations, event.getOriginal().getCapability(capabilityInspirations, null), null);
            storageInspiration.readNBT(capabilityInspirations, event.getEntityPlayer().getCapability(capabilityInspirations, null), null, nbt);
        }
    }
