...
public class ItemHayTorch extends Item implements IHasModel {
	...
	public EnumActionResult onItemUse(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand,
			EnumFacing facing, float hitX, float hitY, float fitZ) {
...
//							storage.readNBT(CapabilityHandler.capInspirations,
//									playerIn.getCapability(CapabilityHandler.capInspirations, null), null, nbt);
...
//									new TextComponentTranslation("inspiration." + inspName + ".name"), false);
//						}
//					}
//				}
			}
	...
	public boolean tryOnFire(World worldIn, BlockPos pos, EntityPlayer playerIn) {
		...
		if (worldIn.isAirBlock(pos)) {
			...
			worldIn.playSound(playerIn, pos, SoundEvents.ITEM_FLINTANDSTEEL_USE, SoundCategory.BLOCKS, 1.0F,
